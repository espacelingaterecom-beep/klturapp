          ...
          >
            <div className="text-center mb-10">
              <h1 className="text-3xl font-black text-white uppercase tracking-tight mb-2">
                {showForgot ? 'Réinitialiser' : 'Espace'} <span className="text-[#D4AF37]">{showForgot ? 'le mot de passe' : 'Artiste'}</span>
              </h1>
            ...
            {showForgot ? (
              <form onSubmit={handleResetPassword} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="forgotEmail" className="text-white/80 font-bold">Email</Label>
                  <Input
                    id="forgotEmail"
                    type="email"
                    value={forgotEmail}
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-[10px] text-[#D4AF37] hover:underline font-bold uppercase tracking-wider"
                      >
                        Mot de passe oublié ?
                      </button>
                    </div>
